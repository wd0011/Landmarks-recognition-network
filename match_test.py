# -*- coding: utf-8 -*-
"""
Created on Fri Oct 19 14:23:09 2018
...
'''
==================This part is try to get image from dataset===================

First of all, we should resize image here, and the load it to the next part.
'''
...
# We should restore the locations and theri descriptors for each images in a file with label.
# Then, we can store the locations and the descriptors and then write a for loop to count the feature matches.
